   ...
   // array of wrapped text field views
	...
	private Action[] sorts = new Action[]
	{
            ...
            new SimpleAction(buttonNames[1]) {
                public void perform(){ runExperiment(SortingExperiment.mergeSort, buttonNames[1]); } },
            
            new SimpleAction(buttonNames[2]) {
                public void perform(){ runExperiment(SortingExperiment.bubbleSort, buttonNames[2]); } },
           
            new SimpleAction(buttonNames[3]) {
                public void perform(){ runExperiment(SortingExperiment.insertionSort, buttonNames[3]);  } }
	 };
